...
insert into Trabajador(EmployeeID, Name, Position,Department,Address, AnnualSalary)   
values('1190','Reynaldo Castaño','Docente Titular 140','Informatica','Managua',520000)

select * from Trabajador

insert into Trabajador(EmployeeID, Name, Position,Department,
Address, AnnualSalary)   values('1184','Evelyn Espinoza','Docente Titular 140','Informatica','Managua',550000)
