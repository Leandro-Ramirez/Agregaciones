...
insert into Facultad values('01','FTC','Pepito','1995-02-01')
insert into Facultad values('02','FTI','Juanito','1995-02-01')
insert into Facultad values('03','FCyS','Claudia Benavidez','1997-02-01')
	 ...
	 begin
	  if(@pdt='2' or @pdt='5' or @pdt='7' or @pdt='8')
	   begin
	    if(@idfac=@IDF)
         begin
		  insert into Clientes values(@IDC,@PNC,@SNC,@PAC,@SAC,@DC,@IDM,@TC,1,@IDF)
		 end
		else
		 begin
...
NCliente '01','Evelyn','','Espinoza','Aragon','Managua',1,'22496429','03'
NCliente '02','Angel','','Zuniga','Espinoza','Managua',8,'52496429','02'
...
begin
 if(@IDC='')
  ...
  begin
   insert into Ventas values(getdate(),@IDC,0)
  end
 end
else
 begin
