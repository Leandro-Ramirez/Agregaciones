...
as
begin
select c.IDCARTELERA,p.TITULO,s.DESCRIPCION,c.HORAINICIO,c.HORAFIN,c.FECHA,e.DESCRIPCION 
as 'estado' from CARTELERA c 
...
as
begin
select V.IDVENTA,V.FECHA,C.NOMBRE+' '+C.APELLIDO as CLIENTE,R.HORAINICIO,R.HORAFIN,P.TITULO as PELICULA,D.NOMBRE+' '+D.APELLIDO 
as 'empleado',v.FECHA,v.ASIENTOS,v.TPAGO,v.PROMOCION,v.DESCUENTO,E.DESCRIPCION from VENTA V
